...
public class testFitnessFuntion {
    public static void main(String[] args) {
         ...
         */ 
        YinYangChromosome chromosome = new YinYangChromosome(4, bitSet);

        YinYangFitnessFunction fitness = new YinYangFitnessFunction();
        double fitnes = fitness.evaluate(chromosome);
